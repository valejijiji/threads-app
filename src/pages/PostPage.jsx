    ...
    <>
      ...
      <Flex>
        ...
        <Flex gap={4} alignItems={"center"}>
          <Text fontSize={"sm"} color={"gray.light"}>10d</Text>
      ...
      <Flex gap={2} alignItems={"center"}>
         ...
         <Text color={"gray.light"} fontSize={"small"}>{1000+ (liked ? 1 : 0)} likes</Text>
      </Flex>
      ...
      <Flex justifyContent={"space-between"}>
        <Flex gap={2} alignItems={"center"}>
          <Text fontSize={"xl"} color={"gray.light"}>Hey aqui puedes comentar y ver los comentarios de los demas! </Text> 
        </Flex>
